...
public class Font implements HasCssProperties {
	...
	public static void setDefault( Font font ) {
		if( defaultFont!=null ) {
			throw new IllegalStateException("Default font can only be set once and must also be set prior to calling Font.getDefault() method");
		}
		defaultFont = font;
	}
	...
	public static Font getDefault() {
		if( defaultFont==null ) {
			defaultFont = new Font(DROID_SANS, 12);
		}
		return defaultFont;
	}
